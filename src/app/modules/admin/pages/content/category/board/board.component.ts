...
import { CategoryAddListComponent } from '../add-list/add-list.component';
import { Board, Card, List } from '../../content.models';
...
export class ScrumboardBoardComponent implements OnInit, OnDestroy {
    ...
    addList(title: string): void {
        ...
        // Save the list
        this._contentService.createList(list).subscribe();
    }
    ...
    updateListTitle(event: any, list: List): void {
        ...
        // Update the list
        this._contentService.updateList(list).subscribe();
    }
    ...
    deleteList(id): void {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                // Delete the list
                this._contentService.deleteList(id).subscribe();
            }
        });
    }
    ...
    addCard(list: List, title: string): void {
        ...
        // Save the card
        this._contentService.createCard(card).subscribe();
    }
    ...
    listDropped(event: CdkDragDrop<List[]>): void {
        ...
        // Update the lists
        this._contentService.updateLists(updated).subscribe();
    }
    ...
    cardDropped(event: CdkDragDrop<Card[]>): void {
        ...
        // Update the cards
        this._contentService.updateCards(updated).subscribe();
    }
